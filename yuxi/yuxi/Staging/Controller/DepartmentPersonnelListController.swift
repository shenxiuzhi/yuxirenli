//
//  DepartmentPersonnelListController.swift
//  yuxi
//
...
class DepartmentPersonnelListController: YUXIBaseController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.image.image = UIImage.init(named: "Staging_Department_Personnel")
